...
export class Tetris {
    ...
    constructor(canvas_id) {
        ...
        const ret = wasm.tetris_new(ptr0, len0);
        if (ret[2]) {
    ...
    render() {
        wasm.tetris_render(this.__wbg_ptr);
    }
    move_down() {
        wasm.tetris_move_down(this.__wbg_ptr);
    }
    move_left() {
        wasm.tetris_move_left(this.__wbg_ptr);
    }
    move_right() {
        wasm.tetris_move_right(this.__wbg_ptr);
    }
    start() {
    ...
    rotate_counterclockwise() {
        wasm.tetris_rotate_counterclockwise(this.__wbg_ptr);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wastrs_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
